...
interface ReportViewProps {
  report: any; // Using any to handle serialized dates and complex structure
  lang: string;
  dict: any;
}
                ...
                <div className="text-card-foreground flex flex-col gap-6 rounded-xl border bg-white/95 backdrop-blur-sm shadow-xl">
                  ...
                  <div className="px-3 [&:last-child]:pb-6 space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium text-gray-900" suppressHydrationWarning>{report.publishedDate ? new Date(report.publishedDate).toLocaleDateString(lang, { month: 'short', year: 'numeric' }) : 'N/A'}</span>
                    </div>
                    <div className="flex items-center justify-between">

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
               {/* Social Icons */}
               <a href="https://www.linkedin.com/company/fior-markets" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-700 rounded-full hover:bg-blue-600 transition-colors cursor-pointer flex items-center justify-center">
               ...
               <a href="https://www.facebook.com/fiormarkets/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-700 rounded-full hover:bg-blue-800 transition-colors cursor-pointer flex items-center justify-center">
               ...
               <a href="https://x.com/fiormarkets" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-700 rounded-full hover:bg-gray-800 transition-colors cursor-pointer flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                 ...
                 <span>sales@fiormarkets.com</span>
              </li>
            </ul>
          </div>
        </div>

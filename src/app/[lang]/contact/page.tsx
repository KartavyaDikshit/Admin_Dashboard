          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-left">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#contact-form" className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all h-10 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 px-8 py-3 shadow-md hover:shadow-lg">Request Callback</a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div data-slot="card" className="bg-card text-card-foreground flex flex-col gap-6 rounded-xl border text-center group hover:shadow-lg transition-all duration-300">
              <div data-slot="card-content" className="[&_:last-child]:pb-6 p-8">
                ...
                <a href="tel:+13152151633" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all h-9 px-4 py-2 w-full bg-indigo-600 hover:bg-indigo-700 text-white">Call Now</a>
              </div>
            </div>
            <div data-slot="card" className="bg-card text-card-foreground flex flex-col gap-6 rounded-xl border text-center group hover:shadow-lg transition-all duration-300">
              <div data-slot="card-content" className="[&_:last-child]:pb-6 p-8">
                ...
                <a href="mailto:sales@thebrainyinsights.com" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all h-9 px-4 py-2 w-full bg-indigo-600 hover:bg-indigo-700 text-white">Send Email</a>
              </div>
            </div>
          </div>
        </div>

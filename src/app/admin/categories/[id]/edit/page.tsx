...
import { Category, CategoryTranslation, TranslationStatus } from '@prisma/client' // Import CategoryTranslation
...
export default function EditCategoryPage() {
  ...
  const [translatedData, setTranslatedData] = useState<CategoryTranslation | null>(null)
    ...
    return (
      <AdminLayout>
        <div className="text-center py-12">
          <h2 className="text-2xl font-semibold text-black">Category Not Found</h2>
  ...
  const availableLocales = ['en', 'de', 'fr', 'it', 'ja', 'ko', 'es']; // Example locales
  ...
  return (
    <AdminLayout>
      <div className="container mx-auto p-4">
        ...
        {/* Original Category Form */}
        <h2 className="text-xl font-bold mb-3 text-black">Original Category Data</h2>
        {initialData && (

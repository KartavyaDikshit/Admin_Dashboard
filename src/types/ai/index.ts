...
export const PROMPT_CONFIGS: Record<string, PromptConfig> = {
  ...
  prompt4: {
    ...
    template: 'Create Key Players section for {title}. Context: {context}. Part 1: List top 10 verified companies (publicly traded/recognized). Part 2: Provide 1-2 real 2025 developments with format "[Month] 2025: [Company] [action] to [outcome]". Use credible company names only, no placeholders.',
    maxTokens: 450,

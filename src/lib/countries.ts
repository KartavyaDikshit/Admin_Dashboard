...
export const countries: Country[] = [
  ...
  { name: 'Bulgaria', code: '+387', iso: 'BG' },
  { name: 'Burkina Faso', code: '+226', iso: 'BF' },
  { name: 'Burundi', code: '+226', iso: 'BI' },
  { name: 'Cabo Verde', code: '+257', iso: 'CV' },
  ...
  { name: 'Czechia (Czech Republic)', code: '+420', iso: 'CZ' },
  { name: 'Denmark', code: '+420', iso: 'DK' },
  { name: 'Djibouti', code: '+269', iso: 'DJ' },
  ...
  { name: 'Palestine State', code: '+970', iso: 'PS' },
